...
<html lang="en">
  ...
  <body>
    <h1 class="head1"><u>Who Needs a Tablet?</u></h1>
    <p class="para1">
      Tablets are versatile devices that cater to a wide range of users. They
      are ideal for those who need a portable device for casual browsing, media
      consumption, or light productivity tasks. Students benefit from tablets as
      they provide easy access to e-books, educational apps, and note-taking
      capabilities. Professionals can use tablets for presentations, quick
      document edits, and on-the-go work. Creative individuals, such as artists
      and designers, find tablets invaluable for digital drawing and design
      work, especially with the support of styluses. Families also enjoy tablets
      as shared devices for entertainment, gaming, and staying connected.
      Overall, tablets offer a convenient and portable option for anyone looking
      for a device that bridges the gap between smartphones and laptops.
    </p>
    <div class="container mt-5 mb-5">
      <div class="d-flex justify-content-center row">
        <div class="col-md-10">
          ...
          <?php
          $select_query="select * from `products5`";
