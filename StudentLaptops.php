...
<html lang="en">
  ...
  <body>
    <h1 class="head1">
      <u>
        Perfect for Students: Essential Laptops for Learning and Productivity
      </u>
    </h1>
    <p class="para1">
      Student laptops are designed to meet the unique needs of learners,
      offering a balance of performance, portability, and affordability. These
      laptops typically feature lightweight designs for easy transport between
      classes, long battery life to last through study sessions, and enough
      processing power to handle academic software and multimedia tasks. They
      are ideal for completing assignments, conducting research, and staying
      connected with classmates and teachers. With a range of options catering
      to various budgets and specifications, student laptops ensure that
      learners can find the perfect device to support their educational journey.
    </p>
    <div class="container mt-5 mb-5">
      <div class="d-flex justify-content-center row">
        <div class="col-md-10">
          ...
          <?php
          $select_query="select * from `products4`";
