...
<html lang="en">
  ...
  <body>
    <h1 class="head1">
      <u>Power and Professionalism: A Guide to Business Laptops</u>
    </h1>
    <p class="para1">
      Business laptops are designed to meet the rigorous demands of the
      corporate world. They prioritize durability, security, and performance,
      often featuring robust processors, ample storage, and long battery life.
      These laptops are equipped with enterprise-level security features like
      biometric authentication and encryption to protect sensitive data.
      Additionally, they offer ergonomic designs and high-quality displays,
      ensuring comfort and clarity during long work hours. Whether for running
      complex applications or ensuring smooth video conferencing, business
      laptops are essential tools for professionals seeking reliable and
    ...
    <div class="container mt-5 mb-5">
      <div class="d-flex justify-content-center row">
        <div class="col-md-10">
          ...
          <?php
          $select_query="select * from `products3`";
